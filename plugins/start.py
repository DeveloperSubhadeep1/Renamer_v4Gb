...
async def start(client, message):
    ...
    await message.reply_photo(photo=BOT_PIC,
                                ...
                                reply_markup=InlineKeyboardMarkup(
                                        [[InlineKeyboardButton("📢 Updates", "https://t.me/+y3SBdS3ajTQzNzQ1"),
                                        InlineKeyboardButton("💬 Support", "https://t.me/+y3SBdS3ajTQzNzQ1")],
                                        [InlineKeyboardButton("🛠️ Help", callback_data='help'),
				                        InlineKeyboardButton("❤️‍🩹 About", callback_data='about')],
                                        [InlineKeyboardButton("🧑‍💻 Developer 🧑‍💻", "https://t.me/+y3SBdS3ajTQzNzQ1")]
                                        ]))
    return
    ...
    if update_channel:
        try:
            ...
            await message.reply_text("<b>Hello Dear \n\nYou Need To Join In My Channel To Use Me\n\nKindly Please Join Channel</b>",
                                     ...
                                     reply_markup=InlineKeyboardMarkup(
                                         [[InlineKeyboardButton("🔺 Update Channel 🔺", "https://t.me/+y3SBdS3ajTQzNzQ1")]]))
